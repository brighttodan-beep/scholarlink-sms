...
// Initialize Firebase
try {
    // We use the older 'firebase.initializeApp' syntax to be compatible with the older SDKs imported in index.html
...
function attachGlobalListeners() {
    ...
    // CRITICAL: This attaches the function to the button click
    if (loginBtn) {
...
async function initializeApplicationLogic(user) {
    ...
    try {
        ...
        // 4. Start on the first active module based on the role
